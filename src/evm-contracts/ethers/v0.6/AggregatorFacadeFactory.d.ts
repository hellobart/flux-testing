...
export declare class AggregatorFacadeFactory extends ContractFactory {
    ...
    deploy(_aggregator: string, _decimals: BigNumberish, overrides?: TransactionOverrides): Promise<AggregatorFacade>;
    getDeployTransaction(_aggregator: string, _decimals: BigNumberish, overrides?: TransactionOverrides): UnsignedTransaction;
